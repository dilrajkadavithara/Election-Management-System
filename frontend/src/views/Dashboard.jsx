    ...
    return (
        <div className="min-h-screen lux-mesh-bg p-12 pl-96 space-y-12 lux-animate-in pb-32">
            ...
            <header className="flex justify-between items-center border-b border-white/5 pb-12 relative z-20">
                <div>
                    <h3 className="font-black uppercase tracking-[0.3em] text-[10px] text-emerald-500 mb-2 italic">Live Intelligence Stream</h3>
            ...
            <div className="grid grid-cols-12 gap-10 relative z-10">
                {/* Sentiment Analysis (VoteIntel) - Main Feature */}
                <div className="col-span-8 lux-card p-10 relative overflow-hidden group">
                    ...
                    <div className="flex justify-between items-start mb-8 relative z-10">
                        ...
                        <div className="flex gap-6">
                            {[
                                { label: 'Total Registered', value: dashboardStats.tagging_progress || total, color: 'text-white' },
                                { label: 'Male representation', value: dashboardStats.gender?.male || 0, color: 'text-indigo-400' },
                                { label: 'Female representation', value: dashboardStats.gender?.female || 0, color: 'text-rose-400' }
                            ].map((stat, i) => (
                                <div key={i} className="text-right">
                                    <span className={`block text-3xl font-black ${stat.color} tracking-tighter`}>{stat.value.toLocaleString()}</span>
                ...
                {/* Right Column: Age & Digitization */}
                <div className="col-span-4 space-y-10">
                    {/* Age Composition */}
                    <div className="lux-card p-10 h-[280px] flex flex-col justify-between relative overflow-hidden">
                    ...
                    {/* Digitization Level */}
                    <div className="lux-card p-10 bg-slate-900/50 border border-indigo-500/20 relative group">
                        ...
                        <div className="mt-6 flex flex-col gap-2">
                            <div className="flex justify-between items-end">
                                ...
                                <span className="text-[10px] font-black text-indigo-400 uppercase tracking-widest">Records digitized</span>
                            </div>
            ...
            {/* --- WAR ROOM MODULE (REPLACING OLD COMMAND CENTER) --- */}
            <div className={`mt-20 border-t border-white/5 pt-12 ${activeBrand.gradient} rounded-[3rem] p-10 transition-all duration-1000`}>
                <div className="flex justify-between items-start mb-12">
                    <div>
                        <h2 className="text-4xl font-black uppercase tracking-tighter leading-tight flex items-center gap-4">
                            War Room <span className="text-base bg-white text-black px-3 py-1 rounded font-black tracking-widest">V2</span>
                        </h2>
                        <p className={`font-black uppercase tracking-[0.3em] text-[10px] ${activeBrand.text} mt-4`}>Tactical Operations Center &bull; {perspective} Mode</p>
                    </div>
                ...
                <div className="grid grid-cols-12 gap-8">
                    ...
                    <div className="col-span-5 bg-black/20 rounded-3xl p-8 border border-white/5 flex flex-col justify-between">
                        ...
                        <div className="flex gap-4 mt-6">
                            <button onClick={() => { setListFilters({ ...listFilters, leaning: 'NEUTRAL', location: 'LOCAL' }); setView('voters'); }} className="bg-emerald-500 hover:bg-emerald-600 text-black px-6 py-3 rounded-xl font-black text-[9px] uppercase tracking-widest w-full transition-all">Go to War Room</button>
                        </div>
                    </div>
