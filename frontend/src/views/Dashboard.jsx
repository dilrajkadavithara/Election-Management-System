        ...
        <div className="min-h-screen lux-mesh-bg p-12 pl-96 space-y-12 lux-animate-in">
            <header className="flex justify-between items-end border-b border-white/5 pb-10">
                <div>
                    ...
                    <p className="text-slate-300 font-black uppercase tracking-[0.4em] text-[10px] mt-2 ml-1">AI driven Campaign</p>
                </div>
            ...
            <div className="grid grid-cols-3 gap-10">
                {[
                    ...
                    { l: 'Male representation', v: dashboardStats.male, c: 'from-blue-600/20 to-blue-900/20', icon: '🛡️' },
                    { l: 'Female representation', v: dashboardStats.female, c: 'from-rose-600/20 to-rose-900/20', icon: '✨' },
                ].map((s, i) => (
            ...
            <div className="grid grid-cols-3 gap-10 pb-20">
                <div className="lux-card bg-gradient-to-br from-emerald-600/10 to-emerald-900/10 flex flex-col justify-between h-[300px]">
                    <div>
                        ...
                        <h2 className="text-4xl font-black uppercase tracking-tighter leading-tight">Target neutrals</h2>
                    ...
                    <button onClick={() => { setListFilters({ ...listFilters, leaning: 'NEUTRAL' }); setView('voters'); }} className="lux-btn-primary w-fit mt-10">Get the list</button>
                </div>
